...
The answer should sound like this style:
...
- human-readable
- no raw field names like expected_cash_30_days
- no object formatting
- no code blocks
"""
    ...
    try:
        ...
        try:
            ...
            return {
                ...
                "assumptions": "Model returned non-JSON text, so the raw response was displayed.",
            }
...
def chat(req: ChatRequest):
    try:
        ...
        result = run_clarification_logic(
            req.message, req.history, ar_context, direct_context
        )
