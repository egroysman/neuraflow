              ...
              >
                {history.length === 0 && (
                  <p style={{ color: "#6b7280" }}>
                    Upload invoice data and ask:
                    <br />
                    “What is expected cash in the next 30 days?”
                    <br />
          ...
          <div style={{ display: "grid", gap: "20px" }}>
                ...
                {dashboardData?.top_expected_payers_next_30_days
                  ...
                  .map((c: any, i: number) => (
                    ...
                    >
                      ...
                      <div>
                        Predicted payment date: {c.predicted_payment_date || "N/A"}
                      </div>
                    </div>
                  ))}
              </div>
            ...
            <div style={panelStyle}>
              ...
              <div>
                ...
                <div>Finance AI + 30-Day Cash Forecast + Actions + Drill-Down</div>
              </div>
            </div>
          </div>
        </div>
